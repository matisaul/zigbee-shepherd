...
query._network = function (param, callback) {
    ...
    return Q.fcall(function () {
        ...
        else if (param === 'CHANNEL' || param === 'PAN_ID')
            return controller.request('UTIL', 'getNvInfo', {}).fail(function (err, rsp) {
                return (!err || err.message === 'rsp error: 8') ? Q.defer(rsp) : Q.reject(err);
            });
